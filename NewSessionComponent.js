  ...
  return (    
    <View style={styles.container}>
      ...
      <View style={styles.menuButtonsInline}>
        <TouchableOpacity style={styles.menuButtonInline}><Text style={styles.buttonLabelInline}>New Patient ➕</Text></TouchableOpacity>
        <TouchableOpacity style={styles.menuButtonInline}>
          <Text style={styles.buttonLabelInline}>Assign Patient</Text>
        </TouchableOpacity>
      </View>
